  ...
  <div class="w-full max-w-sm bg-white p-5 rounded-3xl shadow-2xl mb-16">
      ...
      <form action="navbar" class="mt-4">
          ...
          <div class="flex justify-between items-center mt-3">
              <a href="resetpassword" class="text-[#8B5E3B] text-sm hover:text-[#8B5E3B] hover:underline" >Reset Password?</a>
          </div>
          <button class="w-full mt-4 bg-[#2c1f11] text-white p-2 rounded-lg hover:bg-[#b8925c] transition">Login</button>
      </form>
