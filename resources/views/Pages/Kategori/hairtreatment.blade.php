    ...
    @section('content')
        <header class="bg-white shadow-sm pt-24">
            <div class="container mx-auto px-4 py-6 ">
                <h1 class="text-3xl font-bold tracking-tight text-[#2c1a0f]">Hair Treatment</h1>
            </div>
        </header>
        <section class="py-16 ">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 ">
                    ...
                    @foreach ($treatments as $treatment)
                        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                @php
                                    $userMembership = Auth::user()?->userMembership?->load('membership');
                                ...
                                @auth
                                    <button
                                        onclick="openModal('{{ $treatment->name }}', '{{ $treatment->description }}', {{ $treatment->price }}, {{ $treatment->id }},  '{{ $treatment->category->name ?? '' }}', {{ $discount }})"
                    ...
                    <script>
                        ...
                        function openModal(namaPaket, deskripsiPaket, harga, treatmentId, category, diskonMember) {
                        ...
                        function updateJam() {
                            ...
                            jamOptions.forEach(jam => {
                                const jamMulai = jam.split("-")[0]; // Ambil waktu mulai, misal "10:00"
